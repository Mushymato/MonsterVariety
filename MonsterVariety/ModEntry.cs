...
public class ModEntry : Mod
{
    ...
    public override void Entry(IModHelper helper)
    {
        ...
        GameStateQuery.Register($"{ModId}_LUCKY_RANDOM", GameDelegates.LUCKY_RANDOM);
        GameStateQuery.Register($"{ModId}_SYNCED_LUCKY_RANDOM", GameDelegates.SYNCED_LUCKY_RANDOM);
        ItemQueryResolver.Register($"{ModId}_MONSTER_DROPS", GameDelegates.MONSTER_DROPS);
    }
